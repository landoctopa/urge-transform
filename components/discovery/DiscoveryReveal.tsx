...
interface DiscoveryRevealProps {
  ...
  onChoose: (choice: DiscoveryChoice) => void;
}
...
export function DiscoveryReveal({
  ...
  return (
    <div className="space-y-20">
      ...
      {/* Closing + decision
          The reveal and the next action deliberately form one block. */}
      <section className="border-t border-border pt-14">
        ...
        <div className="mt-10 grid gap-px overflow-hidden border border-border bg-border md:grid-cols-2">
          ...
          <button
            ...
            className="group relative flex min-h-[300px] flex-col bg-foreground p-7 text-left text-background transition-all duration-300 hover:-translate-y-1 hover:ring-2 hover:ring-primary/70 sm:p-9"
          >
          ...
          <button
            type="button"
            onClick={() => onChoose('try_first')}
            className="group relative flex min-h-[300px] flex-col bg-background p-7 text-left transition-all duration-300 hover:-translate-y-1 hover:bg-muted/20 sm:p-9"
          >
            <div className="flex items-start justify-between">
