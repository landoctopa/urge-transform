...
export function hydrateProgramState(
  ...
  if (
    ...
    setUserProfile({
      ...
      networkContext:
        state.profile.networkContext,

      perceivedBarriers:
        state.profile.perceivedBarriers,

      quitConditions:
        state.profile.quitConditions,
